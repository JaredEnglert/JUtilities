...
{
    public class MigrateUpPostReleaseCommand : ConsoleCommand
    {
        ...
        public MigrateUpPostReleaseCommand(IConnectionStringProvider connectionStringProvider, IRepositoryService repositoryService, IEnumerable<Migration> migrations)
        {
            _connectionStringProvider = connectionStringProvider;
            _repositoryService = repositoryService;
            _migrations = migrations;

            IsCommand("migrate-up-post-release", "Runs the MigrateUpPostRelease method on all eligible migrations. It is Step 2, and used at the end of a release.");
        ...
        private async Task RunAsync()
        {
            ...
            Log.Information("Starting MigrationService.MigrateUpPostRelease{0}{0}\tDatabase Type: {1}{0}\tDatabase Name: {2}{0}\tMigration Topic: {3}{0}{4}",
            ...
            await migrationService.MigrateUpPostRelease(_migrationTopic, _versions);

            Log.Information("MigrationService.MigrateUpPostRelease Complete");
        }
    }
}
