...
{
    public class MigrateDownPostRollbackCommand : ConsoleCommand
    {
        ...
        public MigrateDownPostRollbackCommand(IConnectionStringProvider connectionStringProvider, IRepositoryService repositoryService, IEnumerable<Migration> migrations)
        {
            _connectionStringProvider = connectionStringProvider;
            _repositoryService = repositoryService;
            _migrations = migrations;

            IsCommand("migrate-down-post-rollback", "Runs the MigrateDownPostRollback method on all eligible migrations. It is Step 4, and used at the end of a rollback.");
        ...
        private async Task RunAsync()
        {
            ...
            Log.Information("Starting MigrationService.MigrateDownPostRollback{0}{0}\tDatabase Type: {1}{0}\tDatabase Name: {2}{0}\tMigration Topic: {3}{0}{4}",
            ...
            await migrationService.MigrateDownPostRollback(_migrationTopic, _versions);

            Log.Information("MigrationService.MigrateDownPostRollback Complete");
        }
    }
}
